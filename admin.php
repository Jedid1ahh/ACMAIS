										...
										<div class="row">
											...
											<div class="col-xl-6 col-xxl-12  col-md-6 height415 dz-scroll" id="appointment-schedule">
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">Tuesday, July 12th</p>
														<ul>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">Saturday,  July 16th</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Samantha</li>
														</ul>
							...
							<div class="col-xl-12">	
								<div class="card patient-activity">
											...
											<table class="table table-responsive-sm">
												<tbody>
													...
													<tr>
														<td>
															<div class="d-flex">
															<img class="img-2 mr-3" src="image/<?php echo $row['imgName']; ?>" title="<?php echo $row['imgName']; ?>" alt="" >
																<div>
														...
														<td>
															<div>
																...
																<span class="text-primary font-w600 mb-2 d-block text-nowrap"><?php echo $row['status']; ?></span>
									...
									<div class="card-footer text-center border-0">
										<a href="list_of_patients.php" class="btn-link">See More >></a>
									</div>
								</div>
							</div>
						</div>
