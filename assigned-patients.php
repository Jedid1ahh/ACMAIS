                                    ...
                                    <table id="example4" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $qry = "SELECT fname FROM doctors WHERE doctor_id = '$nya'";
                                                $query = $db->query($qry);
                                                foreach($query as $rows) :
                                                endforeach;
                                                $name = $rows['fname'];
                                                $sql = "SELECT * FROM patreg WHERE doctor = '$name'";
                                                $result = $db->query($sql);
                                                if(!$result){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['secondvisit']; ?> </td>
                                                <td><?php echo $row['thirdvisit']; ?> </td>
                                                <td><?php echo $row['finalvisit']; ?> </td>
                                                <td><?php echo $row['edd']; ?> </td>
                                                <td><?php echo $row['status']; ?> </td>
												<td><a href="show-profile.php?id=<?php $row['id']?>">Show Profile</a> </td>
