...
if(isset($_GET['pid']) && isset($_GET['id']) && ($_GET['firstvisit']) && isset($_GET['firstvisittime']) && isset($_GET['fname']) && isset($_GET['lname']) && isset($_GET['imgName'])) {
    $pid = $_GET['pid'];
    $id = $_GET['id'];
    $fname = $_GET['fname'];
    $lname = $_GET['lname'];
...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['id']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname'])){
    $doctor = $_SESSION['did'];
    $appdate = $_POST['firstvisit'];
    $apptime = $_POST['firstvisittime'];
    ...
    $query=mysqli_query($db,"INSERT INTO prescription(doctor,pid,id,fname,lname,appdate,apptime,disease,allergy,prescription) VALUES ('$doctor','$pid','$id','$fname','$lname','$appdate','$apptime','$disease','$allergy','$prescription')");
    $query2 = "UPDATE appointment SET userStatus= '0' , doctorStatus= '0' WHERE id= '$id'";
        ...
        function checklen(){
            var contact = document.getElementById("contact");  
                if((contact.value.length<11) || (contact.value.length >11)){
                    ...
                    document.getElementById('message').innerHTML = 'Phone Number Must be 11 digits';
                    return false;  
                }
            var check = function(){
...
<body>
    ...
    ***********************************-->
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="table-datatable-basic.html">List of Doctors</a></li>
                            <li><a href="table-datatable-basic.html">Appointment List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
    ...
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Make Prescription <?php echo $_SESSION['did']; ?>
   </h3>
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="pres.php">
