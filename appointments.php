                                    ...
                                    <table id="example4" class="display min-w850">
                                        <thead>
                                            <tr>
												...
												<th>Phone Number </th>
                                                <th>Doctor</th>
                                                <th>Date & Time of First Visitation</th>
                                                <th>Date & Time of Second Visitation</th>
                                                <th>Date & Time of Third Visitation</th>
                                                <th>Date & Time of Fourth Visitation</th>
                                                <th>Status</th>
												<th> View Profile </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['firstvisit'] . '-' . $row['firstvisittime']; ?> </td>
                                                <td><?php echo $row['secondvisit'] . '-' . $row['secondvisittime']; ?> </td>
                                                <td><?php echo $row['thirdvisit'] . '-' . $row['thirdvisittime']; ?> </td>
                                                <td><?php echo $row['finalvisit'] . '-' . $row['finalvisittime']; ?> </td>
