        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Appointments List</h2>
					</div>
					<div>
						<a href="javascript:void(0)" data-toggle="modal" data-target="#addOrderModal"></a>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                echo $row['firstvisit']; 
                                            ?></td>
                                        <td><?php echo $row['firstvisittime']; ?> </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
						                    ...
						                    <a href="pres.php?pid=<?php echo $row['pid']?>&id=<?php echo $row['id']?>&fname=<?php echo $row['fname']?>&lname=<?php echo $row['lname']?>&firstvisit=<?php echo $row['firstvisit']?>&firstvisittime=<?php echo $row['firstvisittime']?>&imgName=<?php echo $row['imgName']?>"
                                            ...
                                            ?>
                                                <a href="print_prescription.php?pid=<?php echo $row['pid']?>&id=<?php echo $row['id']?>&fname=<?php echo $row['fname']?>&lname=<?php echo $row['lname']?>&firstvisit=<?php echo $row['firstvisit']?>&firstvisittime=<?php echo $row['firstvisittime']?>"
                                                    tooltip-placement="top" tooltip="Remove" title="prescribe">
                                                    <button class="btn btn-success">View Prescription</button>
                                                </a>
                                                <?php
                                                }
                                            ?>
