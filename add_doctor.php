        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="admin_dashboard.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>ACMAIS</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Patients List</a>
                            <a href="typography.html" class="dropdown-item">Doctors List</a>
                            <a href="element.html" class="dropdown-item">Appointments List</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <?php
                                ...
                                foreach($rows as $row) :
                                ?>
                                <img class="rounded-circle me-lg-2" src="image/<?php echo $row['image']; ?>" title="<?php echo $row['image']; ?>" alt="" style="width: 40px; height: 40px;">
                                <?php endforeach ?>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="index.php">ACMAIS</a>, All Right Reserved. 
                        </div>
