                                ...
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <div class="position-relative">    
                                        ...
                                        <?php
                                            foreach($rows as $row) :
                                        ?>
										<img src="image/<?php echo $row['imgName']; ?>" title="<?php echo $row['imgName']; ?>" style="width: 40px; height: 40px;" class="rounded-circle" alt="">
                                        <?php endforeach; ?>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Appointments History</h2>
					</div>
				</div>
				<!-- Add Order -->
				<div class="row">
							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								<tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM otherappointment WHERE email = '$email'";
                                        $result = $db->query($sql);
                                        if(!$result){
